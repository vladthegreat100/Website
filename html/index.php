...
</style><body><div class="wrap noise"><div class="logo"></div>
<div class="buttonwrap"><div class="buttonwhitespace">
...
<div class="buttonc"><div onclick="window.open('http://overridenetwork.net/forums/index.php','_self')" onmouseout="this.style.background='url(images/forum1.png)'" onmouseover="this.style.background='url(images/forum2.png)'" style="background:url(images/forum1.png);width:235px;height:225px"></div></div>
<div class="buttonc"><div onclick="window.open('http://shop.overridenetwork.net','_self')" onmouseout="this.style.background='url(images/shop1.png)'" onmouseover="this.style.background='url(images/shop2.png)'" style="background:url(images/shop1.png);width:235px;height:225px"></div></div>
<div class="buttonc"><div onclick='votePopup()' onmouseout="this.style.background='url(images/vote1.png)'" onmouseover="this.style.background='url(images/vote2.png)'" style="background:url(images/vote1.png);width:235px;height:225px"></div></div>
<div class="buttonc"><div onclick="window.open('http://overridenetwork.net/staff','_self')" onmouseout="this.style.background='url(images/staff1.png)'" onmouseover="this.style.background='url(images/staff2.png)'" style="background:url(images/staff1.png);width:235px;height:225px"></div></div>
<br><br><br><br><br>
		<div class="statusw">
                   <div class="status">
			...
			<a href="index.htm">
				...
				<p>
                                        ...
                                        <center><font color="2E9AFE"><b>IP:</b></font>
							...
							1.7 - 1.8															<font color="2E9AFE"><b>Players</b></font>
																					...
																					?>
																					<!-- END DO NOT TOUCH -->
												<i class="icon-ok-sign"></i><b><font color="01DF3A">ONLINE</font></b>																									</center>
                 </div>
              </div>
